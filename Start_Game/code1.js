...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10339116);
}
}
if (isConditionTrue_0) {
...
};gdjs.GameCode.asyncCallback10159324 = function (runtimeScene, asyncObjectsList) {
...
gdjs.GameCode.idToCallbackMap.set(10159324, gdjs.GameCode.asyncCallback10159324);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.GameCode.asyncCallback10159324(runtimeScene, asyncObjectsList)), 10159324, asyncObjectsList);
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10156668);
}
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10215812);
}
if (isConditionTrue_0) {
{gdjs.evtTools.runtimeScene.resetTimer(runtimeScene, "pipe_spawn");
}
...
if (isConditionTrue_0) {
/* Reuse gdjs.GameCode.GDLeaderboardDialogObjects3 */
{for(var i = 0, len = gdjs.GameCode.GDLeaderboardDialogObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDLeaderboardDialogObjects3[i].SetTitle("New Highscore!", null);
}
}
...
{for(var i = 0, len = gdjs.GameCode.GDLeaderboardDialogObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDLeaderboardDialogObjects3[i].SetBestScore(runtimeScene.getScene().getVariables().getFromIndex(2).getAsNumber(), null);
}
}
{for(var i = 0, len = gdjs.GameCode.GDLeaderboardDialogObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDLeaderboardDialogObjects3[i].SetTitle("", null);
}
}
...
};gdjs.GameCode.asyncCallback10056660 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.GameCode.localVariables);
...
gdjs.GameCode.idToCallbackMap.set(10056660, gdjs.GameCode.asyncCallback10056660);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.GameCode.asyncCallback10056660(runtimeScene, asyncObjectsList)), 10056660, asyncObjectsList);
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10053828);
}
if (isConditionTrue_0) {
